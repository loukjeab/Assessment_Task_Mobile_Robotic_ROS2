...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory('simple_robot_nav2_ros2'), 'worlds', world_file_name)
    ...
    xacro_file = os.path.join(get_package_share_directory('simple_robot_nav2_ros2'),
                              'urdf',
                              'simple_robot_nav2.urdf.xacro')
    rviz_file = os.path.join(get_package_share_directory('simple_robot_nav2_ros2'),
                              'rviz',
